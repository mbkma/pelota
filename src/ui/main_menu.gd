...
func _on_tournament_pressed() -> void:
	level_changed.emit(load("res://src/ui/tournament-main-menu.tscn"), null)
...
func _on_career_pressed() -> void:
	level_changed.emit(load("res://src/modes/career/new_career.tscn"), null)


func _on_training_pressed() -> void:
	level_changed.emit(
		load("res://src/environment/tennis_location/training_center/training_center.tscn"), null
	)
...
func _on_start_pressed() -> void:
	...
	level_changed.emit(load("res://src/modes/tennis_session/tennis_match.tscn"), null)
