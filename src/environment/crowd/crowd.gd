...
@export var crowd_after_point_sounds := [
	preload("res://src/environment/crowd/sounds/crowd-after-point1.wav"),
	preload("res://src/environment/crowd/sounds/crowd-after-point2.wav"),
]
@export var crowd_idle_sounds := [
	preload("res://src/environment/crowd/sounds/crowd-idle.wav"),
]
...
func play_sound(stream: AudioStream, _loop := false):
