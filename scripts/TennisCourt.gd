...
var serve_positions: Dictionary = {
	1: [Vector3(-court_dimensions.x / 4, 0, -court_dimensions.z / 2), Vector3(court_dimensions.x / 4, 0, -court_dimensions.z / 2)],
	2: [Vector3(-court_dimensions.x / 4, 0, court_dimensions.z / 2), Vector3(court_dimensions.x / 4, 0, court_dimensions.z / 2)]
}
