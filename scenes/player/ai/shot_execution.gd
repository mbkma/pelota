...
func build_stroke(
	...
	var play_style: PlayStyleProfile = context.play_style
...
func _compute_execution_jitter(
	...
	var consistency: float = stats.shot_control01(context.player_stamina_ratio)
	var timing: float = stats.anticipation01()
	var pressure_resistance: float = stats.pressure_resistance01()
...
func _determine_stroke_type(
	...
	var net_play01: float = stats.tactical_net_play01()
	var slice_skill01: float = stats.spin_control01(Stroke.StrokeType.BACKHAND_SLICE, context.player_stamina_ratio)
...
func _compute_spin(
	...
	var topspin_skill: float = stats.spin_control01(Stroke.StrokeType.FOREHAND, context.player_stamina_ratio)
	var slice_skill: float = stats.spin_control01(Stroke.StrokeType.BACKHAND_SLICE, context.player_stamina_ratio)
